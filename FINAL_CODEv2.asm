...
START: 			CALL SET_LED_ARRAY
			CALL DELAY          ;; GIVE PEOPLE SOME VISUALIZATION OF INTIATING COMMUNICAION
			...
			CALL DELAY_100MS  ;; WAIT BEFORE MODE CHANGES
			MVI D, AK8963_CNTL1
			MVI E, AK8963_PWR_DOWN
			CALL MAG_TRANSFER     
			CALL DELAY_100MS
			...
			CALL DELAY_100MS
			CALL SEND_MAG_DATA    ;; GET DATA FROM AK8963 AT SAMPLE RATE
...
MAG_TRANSFER: 		MVI B, I2C_SLV0_ADDR
			...
			RET
;; THIS FUNCTIONS INSTRUCTS mpu TO GET SENSOR DATA IN EXTERNAL REGISTERS, SUBADDRESS IS STORED IN D
SEND_MAG_DATA:		MVI B, I2C_SLV0_ADDR
			MVI A, AK8963_I2C_ADDR
			ORI I2C_READ_FLAG
			MOV C, A
			CALL SPI_TRANSFER   ;;SET SLAVE 0 TO AK8963 AND SET TO READ
			MVI B, I2C_SLV0_REG
			MVI C , AK8963_HXL
			CALL SPI_TRANSFER ;; SET REGISTER TO I2C_SLV_REG
			MVI B, I2C_SLV0_CTRL
			MVI A, I2C_SLV0_EN
			ORI 04H  ;; GET 4 BYTES 
			MOV C, A
			CALL SPI_TRANSFER ; EANBLE I2C AND REQUEST BYTES
			CALL DELAY_1MS
			RET
